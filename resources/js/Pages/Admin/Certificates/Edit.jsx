...
export default function Edit({ auth, certificate }) {
  ...
  const { data, setData, errors, processing } = useForm({
    ...
    student_name: certificate ? certificate.student_name || "" : "",
    course_name: certificate ? certificate.course_name || "" : "",
    issue_date:
      certificate && certificate.issue_date ? new Date(certificate.issue_date).toISOString().split("T")[0] : "",
    status: certificate ? certificate.status || "valid" : "valid",
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Editar Certificado</h2>}
    >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Sube una nueva imagen para reemplazar la actual, o deja este campo vacío para mantener la imagen
                    existente.
                  </p>
