...
export default function Edit({ auth, user, roles, userRole }) {
  ...
  return (
    <AuthenticatedLayout
      user={auth.user}
      header={<h2 className="font-semibold text-xl text-orange-800 leading-tight">Editar Usuario</h2>}
    >
          ...
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 bg-white border-b border-gray-200">
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  <InputLabel htmlFor="password" value="Contraseña (dejar en blanco para mantener la actual)" />
                  <TextInput
                    id="password"
                    type="password"
                    className="mt-1 block w-full"
