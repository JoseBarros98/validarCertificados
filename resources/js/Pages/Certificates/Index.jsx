  ...
  return (
    <div className="bg-orange-50 min-h-screen">
      ...
      <header className="bg-white border-b border-orange-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="text-xl font-bold text-orange-600">ISPI</div>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-b from-orange-100 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 text-orange-800">
      ...
      <div className="relative h-[400px] mb-20 shadow-md">
        <img src="https://placehold.co/1920x400/FFA500/FFFFFF" alt="Hero" className="w-full h-full object-cover" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-4 text-orange-800">Oferta académica</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="group cursor-pointer transform transition-transform hover:scale-105">
              <div className="aspect-w-16 aspect-h-9 mb-4 overflow-hidden rounded-lg shadow-md">
                <img
                  src="https://placehold.co/500x300/FFA500/FFFFFF"
                  alt="Diplomados"
              ...
              <h3 className="text-xl font-semibold mb-2 text-orange-700 group-hover:text-orange-600">Diplomados</h3>
            ...
            <div className="group cursor-pointer transform transition-transform hover:scale-105">
              ...
              <h3 className="text-xl font-semibold mb-2 text-orange-700 group-hover:text-orange-600">
                Técnico Superior
              </h3>
      ...
      <section className="py-16 bg-gradient-to-b from-orange-50 to-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-4 text-orange-800">Validar certificados</h2>
      ...
      <footer className="bg-orange-800 text-white">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4 text-orange-200">ISPI</h3>
              <p className="text-orange-300 text-sm">Instituto Superior Politécnico Internacional</p>
            </div>
            {[1, 2, 3].map((column) => (
              <div key={column}>
                <h4 className="text-sm font-semibold text-orange-200 mb-4">Topic</h4>
                <ul className="space-y-3">
                  {[1, 2, 3].map((item) => (
                    <li key={item}>
                      <a href="#" className="text-sm text-orange-300 hover:text-white transition-colors">
                        Page
                      </a>
                    </li>
                  ))}
